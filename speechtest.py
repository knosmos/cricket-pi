...
def speechrec_main(listFName):
  ...
  callbacks = [lambda: my_callback(0, models[0]),
             ...
             lambda: my_callback(4, models[4]),
             lambda: my_callback(5, models[5]),
             lambda: my_callback(6, models[6]),
             lambda: my_callback(7, models[7]),
             lambda: my_callback(8, models[8]),
             lambda: my_callback(9, models[9]),
             lambda: my_callback(10, models[10]),
             lambda: my_callback(11, models[11]),
